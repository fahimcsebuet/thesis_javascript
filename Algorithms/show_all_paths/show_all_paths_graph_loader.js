 ...
 */
 ...
 function GraphLoaderShowAllPath(map,callback){
...
GraphLoaderShowAllPath.prototype.load = function(){
	
	this.graph = new Graph();
	this.getNodeList();
}

GraphLoaderShowAllPath.prototype.getNodeList = function(){
	var that = this;
...
GraphLoaderShowAllPath.prototype.loadNode = function(data){
		//console.log(data);
	var map = this.map;
...
GraphLoaderShowAllPath.prototype.getEdgeList = function(){
	var that = this;
...
GraphLoaderShowAllPath.prototype.loadEdgeWithWeight = function(data){
